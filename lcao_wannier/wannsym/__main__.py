...
Python 3 port: faithful reproduction of original symmhr_addrptblock.py
'''
...
def main(workdir=None):
    ...
    # Save original directory and change to workdir
    orig_dir = os.getcwd()
    os.chdir(workdir)
...
def _run_symmetrization():
    # ============================================================
    # Part 1: poswansymop_datas — read inputs and compute symmetry
    # ============================================================
    ...
    # ============================================================
    # Part 2: symmhr_addrptblock — the main symmetrization
    # ============================================================
...
# dump hr_mat. this should also be symmed in r space.
    ...
    print("Done! Output: wannier90_hr.dat_nsymm"+str(nsymm))

if __name__ == '__main__':
    import sys as _sys
    _workdir = _sys.argv[1] if len(_sys.argv) > 1 else None
